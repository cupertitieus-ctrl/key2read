...
const chapters = [
  {
    ...
    questions: [
      { question_number: 1, question_type: 'multiple-choice', question_text: 'How many humans had Tiny met by the end of Chapter 1?', vocabulary_words: [], options: ['Two', 'Three', 'Four', 'Five'], correct_answer: 2, strategy_type: 'finding-details', strategy_tip: 'Go to page 7 — Tiny counts the humans he has met!', explanation: 'Tiny had met four humans: the little girl, her brother, Mom, and Dad.' },
      { question_number: 2, question_type: 'multiple-choice', question_text: 'Why was the brother\'s nickname useful to Tiny?', vocabulary_words: [], options: ['He always shared his toys', 'He always dropped food on the floor', 'He took Tiny on walks', 'He gave Tiny treats from his pockets'], correct_answer: 1, strategy_type: 'finding-details', strategy_tip: 'Go to page 7 — Tiny explains why the nickname is helpful!', explanation: 'The brother always dropped food on the floor, which Tiny knew would come in handy later.' },
